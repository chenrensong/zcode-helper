...
- 修复 Windows 构建(协议接管可恢复、多开实例按窗口标题识别,编译错误)。
- OAuth / BigModel 请求统一 15s 超时;日志不再输出授权码与回调 URL。
- CI 产物附带 SHA256 校验和;README 补充界面截图与完整性校验说明。
...
[Unreleased]: https://github.com/chenrensong/zcode-helper/compare/v1.0.1...HEAD
[1.0.1]: https://github.com/chenrensong/zcode-helper/compare/v1.0.0...v1.0.1
